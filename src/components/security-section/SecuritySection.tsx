...
const securityFeatures = [
  { icon: LockKeyhole, title: "Encrypted information" },
  { icon: ShieldCheck, title: "Secure authentication" },
  { icon: FileLock2, title: "Document integrity" },
  { icon: EyeOff, title: "Privacy-first design" }
];
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 max-w-xl mx-auto">
            <div className="relative aspect-square w-full max-w-[400px] mx-auto bg-jansahay-bg rounded-full flex items-center justify-center p-12">
              ...
              <div className="bg-white shadow-xl rounded-2xl p-6 relative z-10 w-full max-w-xs flex flex-col items-center text-center">
                ...
                <h3 className="font-semibold text-lg text-jansahay-navy mb-1">Protected</h3>
                <p className="text-sm text-jansahay-text-secondary">Your data is secure</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg text-jansahay-text-secondary mb-8 max-w-lg">
              We treat your personal information, documents, and problems with the utmost confidentiality and security.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {securityFeatures.map((feature, i) => (
                <div key={i} className="flex items-center gap-3">
                  ...
                  <span className="font-medium text-jansahay-text">{feature.title}</span>
                </div>
              ))}
            </div>
          </div>
